...
from oparoquiano.agenda import views

urlpatterns = [
    url(r'^$', views.ListarAgenda.as_view(), name='dashboard'),
    url(r'^edit/(?P<pk>\w+)/$', views.UpdateAgenda.as_view(), name='edit'),
    url(r'^new/$', views.CreateAgenda.as_view(), name='new'),
