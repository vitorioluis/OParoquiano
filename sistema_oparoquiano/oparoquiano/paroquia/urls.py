...
from oparoquiano.paroquia import views

urlpatterns = [
    # url(r'^json/$', 'teste_json', name='teste_json'),
    url(r'^$', views.ListarParoquia.as_view(), name='dashboard'),
    url(r'^edit/(?P<pk>\w+)/$', views.EditParoquias.as_view(), name='edit'),
    url(r'^new/$', views.CreateParoquias.as_view(), name='new'),
