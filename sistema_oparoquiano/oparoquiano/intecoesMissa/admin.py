...
from .models import IntencoesMissa


class IntencoesMissaAdmin(admin.ModelAdmin):
    list_display = ['nome','paroquia', 'intecao', 'created_at', 'updated_at', ]
    search_fields = ['nome','paroquia', 'intecao', 'created_at', 'updated_at', ]


admin.site.register(IntencoesMissa, IntencoesMissaAdmin)
