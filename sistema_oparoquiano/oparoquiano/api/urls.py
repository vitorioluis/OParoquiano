...
from oparoquiano.api import views

urlpatterns = [
    url(r'^json_paroquia/(?P<token>\w+)/$', view=views.gera_json_paroquia, name='api_paroquia'),
    url(r'^json_paroquia/(?P<token>\w+)/(?P<primeira>\w+)/$', view=views.gera_json_paroquia,
        name='api_paroquia_primeira'),
    url(r'^json_agenda/(?P<token>\w+)/(?P<par_id>\w+)/$', view=views.gera_json_agenda, name='api_agenda'),
]