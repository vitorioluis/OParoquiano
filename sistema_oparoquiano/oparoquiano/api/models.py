...
class log_Acesso(models.Model):
    id_paroquia = models.IntegerField("Id da Paroquia")
    acessado_em = models.DateTimeField('Data do Acesso', auto_now_add=True)

    def __str__(self):
        return "log_acesso"

    class Meta:
        verbose_name = 'Log de Acesso API'
        ordering = ['id_paroquia', 'acessado_em', ]
